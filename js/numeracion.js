...
function cargarConfiguracionNumeracion() {
    ...
    if (modo === "pares" && inicio < 2) {
        inicio = 2;
    }

    if (modo === "impares" && inicio < 1) {
        inicio = 1;
    }
...
function actualizarAyudaNumeracion() {
    ...
    const primero = normalizarNumeroParaDireccion(
        inicio,
        modo,
        inversa
    );
